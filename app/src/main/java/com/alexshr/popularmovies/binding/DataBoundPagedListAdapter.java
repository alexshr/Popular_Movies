 ...
 */
public abstract class DataBoundPagedListAdapter<T, V extends ViewDataBinding>
        ...
        if (items == null) {
            ...
            new AsyncTask<Void, Void, DiffUtil.DiffResult>() {
                ...
                protected DiffUtil.DiffResult doInBackground(Void... voids) {
                    return DiffUtil.calculateDiff(new DiffUtil.Callback() {
                        ...
                        public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                            ...
                            return DataBoundPagedListAdapter.this.areItemsTheSame(oldItem, newItem);
                        }
                        ...
                        public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                            T oldItem = oldItems.get(oldItemPosition);
                            T newItem = update.get(newItemPosition);
                            return DataBoundPagedListAdapter.this.areContentsTheSame(oldItem, newItem);
                        }
                    });
                }
                ...
                protected void onPostExecute(DiffUtil.DiffResult diffResult) {
                    ...
                    items = update;
                    diffResult.dispatchUpdatesTo(DataBoundPagedListAdapter.this);
                }
            }.execute();
        }
    }
